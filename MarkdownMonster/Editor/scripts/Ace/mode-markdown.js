...
define("ace/mode/markdown_highlight_rules",["require","exports","module","ace/config","ace/lib/oop","ace/lib/lang","ace/lib/useragent","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(require, exports, module) {
"use strict";
...
define("ace/mode/foxpro_highlight_rules",["require","exports","module","ace/lib/oop","ace/mode/text_highlight_rules"], function(require, exports, module) {
    ...
    var FoxProHighlightRules = function() {
        ...
        var keywords = (
            ...
            "Safety|Save|Scatter|Scheme|Screen|Scroll|Seconds|Seek|Select|Selection|Separator|Set|Show|Shutdown|Size|Skip|Skip|Sort|Space|Sql|Status|Step|Store|Strictdate|String|Structure|Sum|Suspend|Sysformats|Sysmenu|" +
            ...
            "Validate|View|Views|" +
            "Wait|Window|Windows|Windows|Win32api|" +
            "Zap|Zoom" 
        );
...
define("ace/mode/markdown",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/javascript","ace/mode/json","ace/mode/xml","ace/mode/html","ace/mode/csharp","ace/mode/powershell","ace/mode/powershell","ace/mode/markdown_highlight_rules","ace/mode/folding/markdown","ace/mode/javascript","ace/mode/html","ace/mode/sh","ace/mode/sh","ace/mode/xml","ace/mode/css","ace/mode/csharp","ace/mode/csharp","ace/mode/json","ace/mode/javascript","ace/mode/powershell","ace/mode/powershell","ace/mode/foxpro"], function(require, exports, module) {
"use strict";
...
var PsMode = require("./powershell").Mode;
var FoxProMode = require("./powershell").Mode;
...
var Mode = function() {
    ...
    this.createModeDelegates({
        ...
        cs: require("./csharp").Mode,
        json: require("./json").Mode,
        js: require("./javascript").Mode,
        powershell: require("./powershell").Mode,
        ps: require("./powershell").Mode,
        foxpro: require("./foxpro").Mode,
    });
