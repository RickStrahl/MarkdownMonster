...
define("ace/mode/helpbuilder_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(require, exports, module) {
"use strict";
...
var HelpBuilderLangHighlightRules = function() {
    var docComment = DocCommentHighlightRules;
    var builtinFunctions = lang.arrayToMap(
        ('alltrim|AllTrim|formathtml|FormatHtml|topiclink|TopicLink|trim|Trim|').split('|')
    );
    ...
    var builtinVariables = lang.arrayToMap(
        ('$GLOBALS|$_SERVER|$_GET|$_POST|$_FILES|$_REQUEST|$_SESSION|$_ENV|$_COOKIE|$helpbuilder_errormsg|$HTTP_RAW_POST_DATA|' +
    ...
    var builtinFunctionsDeprecated = lang.arrayToMap(
        ...
        'PDF_setpolydash|PDF_setrgbcolor_fill|PDF_setrgbcolor_stroke|PDF_setrgbcolor|PDF_show_boxed|helpbuilder_check_syntax|px_set_tablename|' +
...
oop.inherits(HelpBuilderLangHighlightRules, TextHighlightRules);


var HelpBuilderHighlightRules = function() {
    HtmlHighlightRules.call(this);

    var startRules = [
        {
            token : "support.helpbuilder_tag", // helpbuilder open tag
            regex : "<<(?:helpbuilder|=)?",
            push  : "helpbuilder-start"
        },
        {
            token : "support.helpbuilder_tag", // helpbuilder open tag
            regex : "<<%=",
    ...
    var endRules = [
        {
            token : "support.helpbuilder_tag", // helpbuilder close tag
            regex : ">>",
            next  : "pop"
        }
    ];
    ...
    this.embedRules(HelpBuilderLangHighlightRules, "helpbuilder-", endRules, ["start"]);

    this.normalizeRules();
};

oop.inherits(HelpBuilderHighlightRules, HtmlHighlightRules);

exports.HelpBuilderHighlightRules = HelpBuilderHighlightRules;
exports.HelpBuilderLangHighlightRules = HelpBuilderLangHighlightRules;
});
...
define("ace/mode/helpbuilder",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/helpbuilder_highlight_rules","ace/mode/helpbuilder_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/unicode","ace/mode/html","ace/mode/javascript","ace/mode/css"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var HelpBuilderHighlightRules = require("./helpbuilder_highlight_rules").HelpBuilderHighlightRules;
var HelpBuilderLangHighlightRules = require("./helpbuilder_highlight_rules").HelpBuilderLangHighlightRules;
var MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
var Range = require("../range").Range;
var WorkerClient = require("../worker/worker_client").WorkerClient;
var CstyleBehaviour = require("./behaviour/cstyle").CstyleBehaviour;
...
var HelpBuilderMode = function(opts) {
    this.HighlightRules = HelpBuilderLangHighlightRules;
    this.$outdent = new MatchingBraceOutdent();
    this.$behaviour = new CstyleBehaviour();
    this.foldingRules = new CStyleFoldMode();
};
oop.inherits(HelpBuilderMode, TextMode);
...
(function() {
    ...
    this.$id = "ace/mode/helpbuilder-inline";
}).call(HelpBuilderMode.prototype);

var Mode = function(opts) {
    if (opts && opts.inline) {
        var mode = new HelpBuilderMode();
        mode.createWorker = this.createWorker;
        mode.inlineHelpBuilder = true;
        return mode;
    }
    HtmlMode.call(this);
    this.HighlightRules = HelpBuilderHighlightRules;
    this.createModeDelegates({
        "js-": JavaScriptMode,
        "css-": CssMode,
        "helpbuilder-": HelpBuilderMode
    });
    this.foldingRules.subModes["helpbuilder-"] = new CStyleFoldMode();
};
...
(function() {
    ...
    this.createWorker = function(session) {
        var worker = new WorkerClient(["ace"], "ace/mode/helpbuilder_worker", "HelpBuilderWorker");
        worker.attachToDocument(session.getDocument());

        if (this.inlineHelpBuilder)
