...
Done.
  ...
  [3]: http://markdownmonster.west-wind.com";
        ...
        [TestMethod]
        public void HtmlToMarkdownReverseMarkdown()
        {
            // HTML out of browser usually has all the style information attached to each element
            // so incoming HTML is extremely messy.
            var html =
                @"<h2>Test Page</h2>
