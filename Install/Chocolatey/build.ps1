...
$releasePath = "C:\projects2010\MarkdownMonsterAddins\MarkdownMonsterReleases\v1.13"
...
`$fileType = 'exe'
`$url = 'https://github.com/RickStrahl/MarkdownMonsterReleases/raw/master/v1.13/$file'
